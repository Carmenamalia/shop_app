...
public class UserService {
    ...
    @Autowired
    public UserService(AuthenticationManager authenticationManager, RoleRepository roleRepository, PasswordEncoder passwordEncoder, JwtTokenService jwtTokenService, UserDetailsServiceImpl userDetailsService, UserRepository userRepository) {
    ...
    public User register(AuthRequestDTO authRequestDTO) {
        ...
        Role role = roleRepository.findRoleByRoleType(RoleType.ROLE_USER);
