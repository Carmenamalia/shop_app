...
@Service   // indic jpa ca aceasta este o clasa de service in care voi crea  logica de business a aplicatiei
public class CategoryService {
    private CategoryRepository categoryRepository;
    //injectez been - ul de CategoryRepository prin constructor
